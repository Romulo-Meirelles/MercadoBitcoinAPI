...
Namespace Standard
    ...
    Public MustInherit Class RequesterBase
        ...
        Public Shared Sub HandleError(ByVal Code As String, ByVal Message As String, ByVal Optional innerException As Exception = Nothing, ByVal Optional noThrow As Boolean = False)
            ...
            If Not IsNothing(Code) Then Throw New MercadoBitcoinException(Message, 0, innerException)
        End Sub
        Public MustOverride Function Post(Of T As MercadoBitcoinResponse)(ByVal resource As String, ByVal Optional parameters As Dictionary(Of String, String) = Nothing, Optional Method As HttpMethod = Nothing, Optional Token As String = Nothing, Optional Root As Boolean = False, Optional APITRADE As Boolean = False, ByVal Optional noThrow As Boolean = False) As Task(Of T) Implements IRequester.Post
    End Class
End Namespace
