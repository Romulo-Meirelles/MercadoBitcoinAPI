...
Namespace Standard
    ...
    Public Class HttpClientRequester
        ...
        Public Sub New(ByVal Configuration As ApiConfig, ByVal Client As HttpClient)
            ...
            _Client = Client
        End Sub
        Public Overrides Async Function Post(Of T As MercadoBitcoinResponse)(Resource As String, Optional Parameters As Dictionary(Of String, String) = Nothing, Optional Method As HttpMethod = Nothing, Optional Token As String = Nothing, Optional Root As Boolean = False, Optional APITRADE As Boolean = False, Optional noThrow As Boolean = False) As Task(Of T)
            Dim Deserialized As Object

            If APITRADE = True Then
